<template>
  <div>
    <FilterInteger
      ...
      :value="filters.getFilterValue<CategoryFilterFields['id']>(categoryParentFilterName, categoryFiltersInit.id.key)"
    ...
    <FilterText
      ...
      :value="filters.getFilterValue<CategoryFilterFields['name']>(categoryParentFilterName, categoryFiltersInit.name.key)"
